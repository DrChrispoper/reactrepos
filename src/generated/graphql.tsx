...
export type ReposQuery = (
  ...
  & { search: (
    ...
    & { pageInfo: (
      { __typename?: 'PageInfo' }
      & Pick<PageInfo, 'hasNextPage' | 'endCursor' | 'hasPreviousPage'>
      ...
      { __typename?: 'Repository' }
      & Pick<Repository, 'id' | 'name' | 'forkCount' | 'stargazerCount' | 'url'>
    ) | { __typename?: 'User' }>>> }
  ) }
);

export type MoreReposQueryVariables = Exact<{
  _cursor?: Maybe<Scalars['String']>;
}>;


export type MoreReposQuery = (
  { __typename?: 'Query' }
  & { search: (
    { __typename?: 'SearchResultItemConnection' }
    & Pick<SearchResultItemConnection, 'repositoryCount'>
...
export function refetchReposQuery(variables?: ReposQueryVariables) {
      return { query: ReposDocument, variables: variables }
    }
export const MoreReposDocument = gql`
    query MoreRepos($_cursor: String = null) {
  search(first: 100, type: REPOSITORY, query: "topic:react", after: $_cursor) {
    repositoryCount
    pageInfo {
      hasNextPage
      endCursor
...
/**
 * __useMoreReposQuery__
 *
 * To run a query within a React component, call `useMoreReposQuery` and pass it any options that fit your needs.
 * When your component renders, `useMoreReposQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMoreReposQuery({
 *   variables: {
 *      _cursor: // value for '_cursor'
 *   },
 * });
 */
export function useMoreReposQuery(baseOptions?: Apollo.QueryHookOptions<MoreReposQuery, MoreReposQueryVariables>) {
        return Apollo.useQuery<MoreReposQuery, MoreReposQueryVariables>(MoreReposDocument, baseOptions);
      }
export function useMoreReposLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MoreReposQuery, MoreReposQueryVariables>) {
          return Apollo.useLazyQuery<MoreReposQuery, MoreReposQueryVariables>(MoreReposDocument, baseOptions);
        }
export type MoreReposQueryHookResult = ReturnType<typeof useMoreReposQuery>;
export type MoreReposLazyQueryHookResult = ReturnType<typeof useMoreReposLazyQuery>;
export type MoreReposQueryResult = Apollo.QueryResult<MoreReposQuery, MoreReposQueryVariables>;
export function refetchMoreReposQuery(variables?: MoreReposQueryVariables) {
      return { query: MoreReposDocument, variables: variables }
    }